...
class grid_robot_state:
    ...
    def get_neighbors(self):
        ...
        for x, y in direction:
            if self.is_Valid((self.location[0] + x, self.location[1] + y)):  # all regular neighbors
                ...
                if cur_stairs_weight != 0:
                    ...
                    self.add_neighbor(my_neighbors, self.location[0] + x, self.location[1] + y, new_board, cur_stairs_weight + 2, cur_stairs_weight)
                ...
                if self.stairs != 0 and cur_stairs_weight == 0:
                    ...
                    self.add_neighbor(my_neighbors, self.location[0] + x, self.location[1] + y, new_board, (self.stairs * (-1)) + 2, (self.stairs * (-1)))

        # for n in my_neighbors:
        #     print("neighbors location : " + str(n[0].get_location()) + ', stairs : ' + str(n[0].get_stairs()))
        # print("=============\n")
        return my_neighbors
    ...
    def add_neighbor(self, my_neighbors, dx, dy, new_board, new_cost, cur_stairs_wight):
        n_1 = grid_robot_state((dx, dy), new_board, self.lamp_height, self.lamp_location)
        n_1.set_stairs(self.get_stairs() + cur_stairs_wight)
        my_neighbors.append((n_1, self.stairs + new_cost))
